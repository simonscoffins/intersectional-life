...
namespace IL.Droid.Activities {
    ...
    [Activity(Label = "Main Activity", Theme = "@style/AppTheme",
        ...
        Name = "il.droid.activities.MainActivity")]
    public class MainActivity : MvxCachingFragmentCompatActivity<MainViewModel> {
        ...
        public override void OnBeforeFragmentChanging(IMvxCachedFragmentInfo fragmentInfo, Android.Support.V4.App.FragmentTransaction transaction) {
            ...
            //if (currentFrag != null && fragmentInfo.ViewModelType != typeof(MenuViewModel) && currentFrag.FindAssociatedViewModelType() != fragmentInfo.ViewModelType) {
            //    fragmentInfo.AddToBackStack = true;
            //}

            if (currentFrag != null && fragmentInfo.ViewModelType != typeof(MenuViewModel) &&
                currentFrag.FindAssociatedViewModelType(currentFrag.ViewModel.GetType()) != fragmentInfo.ViewModelType) {
                fragmentInfo.AddToBackStack = true;
            }
