...
namespace IL.Droid.Wibble {
    [Register("il.droid.wibble.wibble")]
    public class Wibble : MvxAppCompatActivity, IFragmentCacheableActivity, IMvxFragmentHost {
        ...
        protected Wibble(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer) { }
        ...
        protected virtual IMvxCachedFragmentInfo GetFragmentInfoByTag(string tag) {
            ...
            var blah = _fragmentCacheConfiguration;

            blah.TryGetValue(tag, out fragInfo);
    ...
    public abstract class Wibble<TViewModel> : Wibble, IMvxAndroidView<TViewModel> where TViewModel : class, IMvxViewModel {
        protected Wibble(IntPtr ptr, JniHandleOwnership ownership) : base(ptr, ownership) {
